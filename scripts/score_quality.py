...
def main() -> int:
    ...
    # the second run re-scores the same day and posts a duplicate "Updated
    # diagnosis" comment. If the day is already published, the primary run did
    # everything — the backstop should no-op.
